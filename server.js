 ...
 * @param  {String}  req.body.topic MQTT Topic (e.g. "smartthings/Bedroom_Light/state")
...
async.series([
    function loadFromDisk (next) {
        ...
        winston.info('Starting SmartThings MQTT Proxy - v%s', CURRENT_VERSION);
    ...
    function setupApp (next) {
        ...
        app.post('/push',
            expressJoi({
                body: {
                    //   "topic": "smartthings/Bedroom_Light/state",
